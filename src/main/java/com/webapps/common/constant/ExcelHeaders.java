...
public class ExcelHeaders {
    ...
    public static final String[] EXPORT_USER_AWARD_EXCHANGE_HEADERS = new String[]{"会员姓名","会员手机","报名时间","奖品名称","是否领取","领取时间"};

    public static final String[] EXPORT_USER_AWARD_EXCHANGE_FIELDS = new String[]{"userName","userMobile","enrollTimeFullStr","awardName","statusStr","exchangeTimeFullStr"};
