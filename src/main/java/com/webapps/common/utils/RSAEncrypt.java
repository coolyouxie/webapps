...
import com.webapps.common.utils.encrypt.AESEncrypt;
import com.webapps.common.utils.encrypt.Base64;

import sun.misc.BASE64Decoder;

public class RSAEncrypt {

	private static final String DEFAULT_PUBLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQChDzcjw/rWgFwnxunbKp7/4e8w"
			+ "\r" + "/UmXx2jk6qEEn69t6N2R1i/LmcyDT1xr/T2AHGOiXNQ5V8W4iCaaeNawi7aJaRht" + "\r"
			+ "Vx1uOH/2U378fscEESEG8XDqll0GCfB1/TjKI2aitVSzXOtRs8kYgGU78f7VmDNg" + "\r" + "XIlk3gdhnzh+uoEQywIDAQAB"
			+ "\r";
	...
	public static void main(String[] args) {
		String data = "XUwHkpwvBIN+PphOpBy6E6igkxEPQQNyCq8QeyaXkbsK34GrNsnOEk8PPo/ziaqwcgbd9t/i/+ioOv8OD3kB7m+1RPJUiecMQO6TvoDSqDQdXWcc8/DLg4j3mQngpdcI9AhJa7Bt9ToxByFy+k/EE+ZLZV2Q96WRHAfzUc52zow=";
		String data1 = "Ubuad8SNdk3VNR3Zig+m7j6/ca8pGwfbTzrVH0SyoYf/9tfY1V7UEHQ0IRNsX/wWOcz0b/lEFNGaGc+bstOc7KDlOzRXao7kzIDkKKp4DS+IzSy68jbol/wBnhO5qOt5WiQrDgYMmblP6+ErZRcCnF0BxRuFN1DikHH8J63cU7w=";
		...
		// 加载公钥
		try {
			rsaEncrypt.loadPublicKey(serverPubKey);
		...
		// 加载私钥
		try {
			rsaEncrypt.loadPrivateKey(serverPriKey);
