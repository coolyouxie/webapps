...
public interface IEnrollmentMapper extends IBaseMapper<Enrollment>,IPageMapper<Enrollment,EnrollmentRequestForm>{
	...
	int queryCountForEntryStatistics(@Param("obj")RateDtoRequestForm form)throws Exception;

	List<Enrollment> queryPageForEntryStatistics(@Param("startRow") int startRow, @Param("endRow") int endRow,
												 @Param("obj")RateDtoRequestForm form)throws Exception;

	int queryCountForExpireStatistics(@Param("obj")RateDtoRequestForm form)throws Exception;
