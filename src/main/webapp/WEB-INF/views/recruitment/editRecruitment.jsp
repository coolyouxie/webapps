...
<div class="container-fluid">
	...
	<form id="saveForm" class="form-horizontal" action="${ctx}/recruitment/saveRecruitment" method="post">
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<textarea id="salaryBriefs" name="salaryBriefs" class="form-control"
				          row="3">${recruitment.salaryBriefs}</textarea>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<textarea id="briefInfo" name="briefInfo" class="form-control"
				          row="3">${recruitment.briefInfo}</textarea>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input type="text" id="mobile" name="mobile" class="form-control" value="${recruitment.mobile}"
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input type="text" id="QQ" name="QQ" class="form-control" value="${recruitment.QQ}"
				       placeholder="请输入发布人QQ号">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input type="text" id="weiXin" name="weiXin" class="form-control" value="${recruitment.weiXin}"
				       placeholder="请输入发布人微信号">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input type="text" id="workType" name="workType" class="form-control" value="${recruitment.workType}"
				       placeholder="工种">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-2">
				<input type="text" class="form-control" id="salaryLow" name="salaryLow" value="${recruitment.salaryLow}"
				       laceholder="最低薪资">
			</div>
			<div class="col-md-2">
				<input type="text" class="form-control" id="salaryHigh" name="salaryHigh"
				       value="${recruitment.salaryHigh}" placeholder="最高薪资">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input class="form-control" id="cashback" name="cashback" value="${recruitment.cashback}"
				       placeholder="返现金额">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<textarea class="form-control" id="cashbackBriefs"
				          name="cashbackBriefs">${recruitment.cashbackBriefs}</textarea>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input class="form-control" id="cashbackDays" name="cashbackDays" value="${recruitment.cashbackDays}"
				       placeholder="期满天数">
			</div>
		</div>
			...
			<div class="col-md-4">
				<c:forEach var="item" items="${tags}">
					<span style="padding-top: 7px;">
						<input type="checkbox"  name="tags" value="${item.id}" ${item.checkStatus}>
						${item.name}
					</span>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</c:forEach>
